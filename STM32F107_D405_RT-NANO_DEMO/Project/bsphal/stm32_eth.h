...
/** @defgroup PHY_Register_address(LAN8720A)
  * @{
  */
#define PHY_BCR                          0 /*!< Tranceiver Basic Control Register */
#define PHY_BSR                          1 /*!< Tranceiver Basic Status Register */
#define PHY_PI1R                         2 /*!< PHY Identifier 1 Register */
#define PHY_PI2R                         3 /*!< PHY Identifier 2 Register */
...
#define PHY_SMR                         18 /*!< Special Modes Register */
#define PHY_SECR                        26 /*!< Symbol Error Counter Register */
#define PHY_SCSIR                       27 /*!< Special Control/Status Indications Register */
#define PHY_ISFR                        29 /*!< Interrupt Source Flag Register */
...
/** @defgroup PHY_basic_Control_register
  * @{
  */
/* used bits[15:8](bit 8 is duplex mode), bits[7:0] reserved */
...
/** @defgroup PHY_basic_status_register
  * @{
  */
#define PHY_Extended_Status             ((u16)0x0100) /*!< Extended Status in register 15 */
#define PHY_AutoNego_Complete           ((u16)0x0020) /*!< Auto-Negotioation process completed */
#define PHY_Remote_Fault                ((u16)0x0010) /*!< Remote Fault detected */
#define PHY_AutoNego_Ability       		((u16)0x0008) /*!< able to perform Auto-Negotiate function */
...
#define PHY_Extended_Capabilities       ((u16)0x0001) /*!< support Extended Capabilities registers */
