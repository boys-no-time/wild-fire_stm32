...
#Database of STM32F107VCT6   64Kbytes RAM	256Kbytes FLASH

//来自于File --> Device Database
//memory CPU_CORE CLOCK
CPU=IRAM(0x20000000-0x2000FFFF) IROM(0x8000000-0x803FFFF) CLOCK(25000000) CPUTYPE("Cortex-M3")	ELITTLE
//FLASH调试配置
...
#define FLASH_APP_MAXSIZE         (0x1d000)
	...
	SRAM:	SRAM_BASE_ADDR (0x20000000)		SRAM_TOTAL_SIZE (0x10000)        //0x20000000 - 0x2000FFFF
